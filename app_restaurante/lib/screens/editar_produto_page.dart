...
class EditarProdutoPage extends StatefulWidget {
  ...
  const EditarProdutoPage({super.key, required this.id});
...
class _EditarProdutoPageState extends State<EditarProdutoPage> {
  ...
  void _carregarProdutos() {
    _produtoFuture = ProdutoService().buscarProduto(widget.id);
  }
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              if (_nomeController.text.isEmpty) {
                _nomeController.text = produto.nome ?? "Sem nome";
                _descricaoController.text = produto.descricao ?? "Sem descrição";
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            ...
                            final mensagem = await ProdutoService().editarProduto(produtoAtualizado);
